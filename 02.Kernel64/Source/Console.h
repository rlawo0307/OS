...
#define COMMAND_SHELL_TYPE			0
#define COMMAND_VI_TYPE				1
////////////////////////////////////////////////////////////////////////////////
//
// 구조체
//
...
typedef struct kCommandEntryStruct
{
	char* pcCommand;
	char* pcHelp;
...
void kExecuteCommand( const char* pcCommandBuffer, COMMANDENTRY* CommandTable , int iCount, COMMANDENTRY* checkTable);
