...
extern kCommonExceptionHandler, kCommonInterruptHandler, kKeyboardHandler, kPagingInterruptHandler, kPageFaultExceptionHandler, kProtectrionFaultExceptionHandler
